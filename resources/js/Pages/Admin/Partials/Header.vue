    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6">
      <div class="flex justify-between items-center border-b-2 border-gray-100 py-6 md:justify-start md:space-x-10">
        ...
        <PopoverGroup as="nav" class="hidden md:flex space-x-10">
          ...
          <a href="/select-store" class="text-base font-medium text-gray-500 hover:text-gray-900">
            Stores
          </a>
          ...
          <a href="/list-expense" class="text-base font-medium text-gray-500 hover:text-gray-900">
            Expenses
          </a>
        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          ...
          <div class="py-6 px-5 space-y-6">
            <div class="grid grid-cols-2 gap-y-4 gap-x-8">
              ...
              <a href="/select-store" class="text-base font-medium text-gray-900 hover:text-gray-700">
                Stores
              </a>
...
const resources = [
  ...
  {
    name: 'Sold Products',
    description: 'List all the products that you have sold.',
    href: '/sold-products',
    icon: ChartBarIcon,
  },
