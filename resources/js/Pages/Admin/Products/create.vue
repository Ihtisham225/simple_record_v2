              ...
              <div class="grid grid-cols-6 gap-6">
                ...
                <div class="col-span-6 sm:col-span-3">
                  ...
                  <select id="seller_id" autocomplete="off" v-model="form.seller_id" class="mt-1 block w-full py-2 px-3 border border-gray-300 bg-white rounded-md shadow-sm focus:outline-none focus:ring-indigo-500 focus:border-indigo-500 sm:text-sm">
                    <option v-for="seller in sellers" :value="seller.id">{{ seller.name }} | {{ seller.shop }}</option>
                  </select>
                </div>
                ...
                <div class="col-span-6 sm:col-span-3">
                  <label for="price" class="block text-sm font-medium text-gray-700">Product Selling Price</label>
                  ...
                  <input type="number" autocomplete="off" v-model="form.sell_price" id="price" class="mt-1 focus:ring-indigo-500 focus:border-indigo-500 block w-full shadow-sm sm:text-sm border-gray-300 rounded-md" />
                </div>
