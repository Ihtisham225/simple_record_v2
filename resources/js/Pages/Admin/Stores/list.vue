                ...
                <div class="py-2 align-middle inline-block min-w-full sm:px-6 lg:px-8">
                    ...
                    <table class="min-w-full divide-y divide-gray-200">
                        ...
                        <tr v-for="r of resultQuery" :key="r.id">
                            ...
                            <div class="text-sm text-gray-900"><a :href="'/store-detail/'+r.id"> {{ r.name }} </a></div>
                            ...
                            <a :href="'edit-store/'+r.id" class="text-indigo-600 hover:text-indigo-900">
                            <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline" viewBox="0 0 20 20" fill="currentColor">
                            <path d="M17.414 2.586a2 2 0 00-2.828 0L7 10.172V13h2.828l7.586-7.586a2 2 0 000-2.828z" />
                            <path fill-rule="evenodd" d="M2 6a2 2 0 012-2h4a1 1 0 010 2H4v10h10v-4a1 1 0 112 0v4a2 2 0 01-2 2H4a2 2 0 01-2-2V6z" clip-rule="evenodd" />
                            </svg>
                            </a>
                            <button @click.prevent="deleteStore(`${r.id}`)" class="text-indigo-600 hover:text-danger-900">
                                <svg xmlns="http://www.w3.org/2000/svg" class="h-5 w-5 inline" viewBox="0 0 20 20" fill="currentColor">
...
export default {
    ...
    computed: {
        ...
        resultQuery() {
        if (this.searchQuery) {
            return this.stores.data.filter(item => {
    ...
    methods: {
        ...
        deleteItem(){
            Inertia.delete(`/delete-store/${this.id}`);
            this.open = false;
        },
