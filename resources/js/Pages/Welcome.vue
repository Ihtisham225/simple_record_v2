        ...
        <div class="rounded-lg shadow-lg ring-1 ring-black ring-opacity-5 bg-white divide-y-2 divide-gray-50">
          <div class="pt-5 pb-6 px-5">
            <div class="flex items-center justify-between">
              <div>
                <img class="h-8 w-auto" :src="'/logo/new_logo.png'" alt="Workflow" />
              </div>
              <div class="-mr-2">
                <PopoverButton class="bg-white rounded-md p-2 inline-flex items-center justify-center text-gray-400 hover:text-gray-500 hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-inset focus:ring-indigo-500">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
      <div class="lg:text-center">
        ...
        <p class="mt-4 max-w-2xl text-xl text-gray-500 lg:mx-auto">
          ...
          market. Here you can find the best Laptop and Mobile dealers and you can easily contact them. It is very simple
          just go to their store below and browse their products.
        </p>
      </div>
        ...
        <div class="bg-gray-100">
          <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="max-w-2xl mx-auto py-16 sm:py-24 lg:py-32 lg:max-w-none">
              <h2 class="text-4xl font-extrabold text-gray-900">Stores</h2>
              ...
              <div class="mt-6 space-y-12 lg:space-y-0 lg:grid lg:grid-cols-3 lg:gap-x-6 row gap-y-8">
                <div v-for="store in stores" :key="store.name" class="group relative border-2 bg-white border-solid rounded-xl hover:shadow-xl transition ease-in-out delay-150 duration-300 p-4">
                  ...
                  <p class="text-base text-center font-semibold text-gray-900">{{ store.address }}</p>
                  <p class="text-base text-center font-semibold text-gray-900">{{ store.phone }}</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <footer class="p-4 bg-white sm:p-6 dark:bg-gray-900">
        ...
        <div class="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="mailto:shamir125@outlook.com" target="_blank" class="hover:underline">shamir125@outlook.com</a>
                    </li>
                    <li>
                        <a href="https://api.whatsapp.com/send?phone=03480152906" target="_blank" class="hover:underline">Whatsapp</a>
                    </li>
                </ul>
            </div>
            <div>
                ...
                <ul class="text-gray-600 dark:text-gray-400">
                    <li class="mb-4">
                        <a href="https://github.com/Ihtisham225" target="_blank" class="hover:underline ">Github</a>
                    </li>
                    <li>
                        <a href="https://www.instagram.com/khan_shamir_official/" target="_blank" class="hover:underline">Instegram</a>
                    </li>
                </ul>
            </div>
        </div>
    ...
    <div class="sm:flex sm:items-center sm:justify-between">
        ...
        <div class="flex mt-4 space-x-6 sm:justify-center sm:mt-0">
            ...
            <a href="https://www.instagram.com/khan_shamir_official/" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://twitter.com/shamir125" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
                <svg class="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true"><path d="M8.29 20.251c7.547 0 11.675-6.253 11.675-11.675 0-.178 0-.355-.012-.53A8.348 8.348 0 0022 5.92a8.19 8.19 0 01-2.357.646 4.118 4.118 0 001.804-2.27 8.224 8.224 0 01-2.605.996 4.107 4.107 0 00-6.993 3.743 11.65 11.65 0 01-8.457-4.287 4.106 4.106 0 001.27 5.477A4.072 4.072 0 012.8 9.713v.052a4.105 4.105 0 003.292 4.022 4.095 4.095 0 01-1.853.07 4.108 4.108 0 003.834 2.85A8.233 8.233 0 012 18.407a11.616 11.616 0 006.29 1.84" /></svg>
                <span class="sr-only">Twitter page</span>
            </a>
            <a href="https://github.com/Ihtisham225" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://dribbble.com/shamir_khan" target="_blank" class="text-gray-500 hover:text-gray-900 dark:hover:text-white">
